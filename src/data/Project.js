...
const projects = [
    {
        id: 1,
        image: 'novocover.png', // Use just the filename as an identifier
        title: 'NovoCamera',
        description: 'tourism and travel website that provides information about various tourist destinations, including hotels, restaurants, and attractions.',
        technologies: ['PHP', 'Bootstrap', 'Ajax', 'JavaScript', 'MySQL'],
    ...
    },
    {
        ...
        technologies: ['React', 'Express JS', 'MYSQL', 'TailwindCSS', 'Axios', 'Context API'],
        /*  liveDemoLink: 'https://moviedb-demo.vercel.app/', */
...

    {
        ...
        technologies: ['UI', 'UX', 'High Fidelity', 'Figma', 'Photoshop', 'Wireframe', 'Prototype'],
        liveDemoLink: 'https://moviedb-demo.vercel.app/',
    ...
    },
    {
        ...
        technologies: ['UI', 'UX', 'High Fidelity', 'Figma', 'Photoshop', 'Wireframe', 'Prototype'],
        liveDemoLink: 'https://www.figma.com/proto/DGgqTZ4E1DwK7NJI2fyH7a/2M-Joshua-La-Rosa-figma?node-id=157-3&starting-point-node-id=165%3A129&t=uFUXg45X0mUE6Jd6-1',


    },
    // Add other projects here if you have more
];
